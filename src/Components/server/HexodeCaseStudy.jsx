...
import HexodeTOC from "../client/HexodeTOC";
import { hexodeCaseStudyData } from "../../data/hexodeCaseStudy";

export default function HexodeCaseStudy({ dict, lang, project, slug }) {
  ...
  const jsonLd = {
    ...
    description: hexodeCaseStudyData.hero.subtitle,
        ...
        <HexodeHeroWrapper images={allImages} title={title}>
          <header className="mb-4">
            ...
            <p className="text-lg md:text-xl text-gray-600 dark:text-gray-300 max-w-2xl leading-relaxed mb-10 font-medium">
              {hexodeCaseStudyData.hero.subtitle}
            </p>
      ...
      <div className="max-w-7xl mx-auto px-5 lg:px-8 pb-32 flex flex-col lg:flex-row gap-10 lg:gap-16 relative items-start">
        ...
        <div className="flex-1 w-full min-w-0 space-y-24">
          ...
          >
            ...
            <H2 icon={Info}>{hexodeCaseStudyData.overview.title}</H2>
            <div className="space-y-4 text-gray-600 dark:text-gray-400 leading-relaxed">
              {hexodeCaseStudyData.overview.content.map((p, i) => (
                <p key={i}>{p}</p>
              ))}
            </div>
          </section>
          ...
          >
            ...
            <H2 icon={Lightbulb}>{hexodeCaseStudyData.problem.title}</H2>
            <div className="space-y-4 text-gray-700 dark:text-gray-300 italic font-medium leading-relaxed">
              {hexodeCaseStudyData.problem.content.map((p, i) => (
                <p key={i}>&quot;{p}&quot;</p>
              ))}
            </div>
          </section>
          ...
          >
            ...
            <H2 icon={Server}>{hexodeCaseStudyData.architecture.title}</H2>
            ...
            <ul className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {hexodeCaseStudyData.architecture.details.map((detail, i) => (
                <li
                  key={i}
          ...
          >
            ...
            <H2 icon={Zap}>{hexodeCaseStudyData.realTime.title}</H2>
            <div className="space-y-6 text-gray-600 dark:text-gray-400 leading-relaxed">
              {hexodeCaseStudyData.realTime.content.map((p, i) => (
                <p key={i}>{p}</p>
              ))}
            </div>
          </section>
          ...
          >
            ...
            <div className="relative z-10">
              <h3 className="text-red-600 dark:text-red-400 font-bold uppercase tracking-wider text-sm mb-2 flex items-center gap-2">
                <Terminal size={16} /> Hard Problem Callout
              </h3>
              <h2 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white mb-6">
                {hexodeCaseStudyData.syncBug.title}:{" "}
                {hexodeCaseStudyData.syncBug.subtitle}
              </h2>
              <div className="space-y-4 text-gray-700 dark:text-gray-300 leading-relaxed">
                {hexodeCaseStudyData.syncBug.content.map((p, i) => (
                  <p key={i}>{p}</p>
                ))}
              </div>
          ...
          >
            ...
            <H2 icon={Cpu}>{hexodeCaseStudyData.execution.title}</H2>
            <div className="space-y-4 text-gray-600 dark:text-gray-400 mb-8 leading-relaxed">
              {hexodeCaseStudyData.execution.content.map((p, i) => (
                <p key={i}>{p}</p>
              ))}
            </div>
            <div className="flex flex-wrap gap-3">
              {hexodeCaseStudyData.execution.supported.map((lang, i) => (
                <span
                  key={i}
          ...
          >
            ...
            <H2 icon={BrainCircuit}>{hexodeCaseStudyData.hexodeAI.title}</H2>
            <div className="space-y-4 text-gray-600 dark:text-gray-400 leading-relaxed">
              {hexodeCaseStudyData.hexodeAI.content.map((p, i) => (
                <p key={i}>{p}</p>
              ))}
            </div>
          </section>
          ...
          >
            ...
            <H2 icon={Code2}>{hexodeCaseStudyData.challenges.title}</H2>
            <div className="space-y-6">
              {hexodeCaseStudyData.challenges.items.map((item, i) => (
                <div
                  key={i}
          ...
          >
            ...
            <H2 icon={Lightbulb}>{hexodeCaseStudyData.decisions.title}</H2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {hexodeCaseStudyData.decisions.items.map((item, i) => (
                <div
                  key={i}
          ...
          >
            ...
            <H2 icon={Monitor}>{hexodeCaseStudyData.limitations.title}</H2>
            <ul className="space-y-4 text-gray-600 dark:text-gray-400 list-disc pl-6 leading-relaxed">
              {hexodeCaseStudyData.limitations.items.map((item, i) => (
                <li key={i}>{item}</li>
              ))}
            </ul>
          </section>
          ...
          >
            ...
            <H2 icon={MessageSquare}>{hexodeCaseStudyData.learned.title}</H2>
            <div className="space-y-4 text-gray-700 dark:text-gray-300 leading-relaxed">
              {hexodeCaseStudyData.learned.content.map((p, i) => (
                <p key={i}>{p}</p>
              ))}
            </div>
            ...
            <div className="mt-12 pt-8 border-t border-electric-indigo/10">
              <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-5">
                {hexodeCaseStudyData.future.title}
              </h3>
              <div className="space-y-4 text-gray-700 dark:text-gray-300 italic font-medium leading-relaxed border-l-4 border-electric-indigo/30 pl-5">
                {hexodeCaseStudyData.future.content.map((p, i) => (
                  <p key={i}>&quot;{p}&quot;</p>
                ))}
              </div>
            </div>
          ...
          >
            ...
            <H2 icon={Server}>{hexodeCaseStudyData.techStack.title}</H2>
            <div className="overflow-x-auto rounded-2xl border border-gray-200 dark:border-white/10 shadow-sm">
              <table className="w-full text-left border-collapse">
                ...
                <tbody className="divide-y divide-gray-200 dark:divide-white/10">
                  {hexodeCaseStudyData.techStack.items.map((item, i) => (
                    <tr
                      key={i}
