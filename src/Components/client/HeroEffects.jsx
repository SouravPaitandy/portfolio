...
const AntigravityParticles = React.memo(function AntigravityParticles() {
...
export default function HeroEffects() {
  ...
  return (
    <>
      ...
      <div className="absolute top-[280px] md:top-[340px] z-20 pointer-events-none">
        {/* We can optionally render the typewriter here if we want to portal it to the h2 */}
      </div>

      <div className="absolute z-20 flex justify-center space-x-4 md:space-x-8 top-[90%] left-1/2 transform -translate-x-1/2">
