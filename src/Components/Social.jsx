...
const Social = () => {
  ...
  return (
    <div className="footer-container max-w-[80%]">
      ...
      className="social-container flex justify-between gap-40 mb-8">
        ...
        <div className="social-icons">
          ...
          <ul className="example-2 flex gap-2"> {/* Added flex and gap for better spacing */}
            ...
            <li className="icon-content transition-transform duration-200 hover:scale-105">
              <a
      ...
      <div className="footer-copy roboto-bold mx-44 mt-6 text-4xl max-w-[70%] border-t-[1px] border-slate-900 dark:border-slate-400 border-opacity-50 dark:border-opacity-50 pt-5 text-center">
        {/* &copy; Copyright {new Date().getFullYear()}.  */}
        <span className="text-gray-900 dark:text-gray-500 opacity-30">Made with{" "}</span>
        <span className="dark:opacity-60">❤️</span> <span className="text-gray-900 dark:text-gray-500 opacity-30">by{" "}</span>
